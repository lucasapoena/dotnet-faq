...
- [ ] [O que é interpolação de String?](categorias/05_strings_e_manipulacao_de_texto.md#o-que-é-interpolação-de-string)
- [ ] [Qual a finalidade do método CompareTo?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-compareto)
- [ ] [Qual a finalidade do método Contains?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-contains)
- [ ] [Qual a finalidade do método StartsWith e EndsWith?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-startswith-e-endswith)
- [ ] [Qual a finalidade do método Equals?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-equals)
- [ ] [Qual a finalidade do método IndexOf e LastIndexOf?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-indexof-e-lastindexof)
- [ ] [Qual a finalidade do método ToLower e ToUpper?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-tolower-e-toupper)
- [ ] [Qual a finalidade do método Insert?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-insert)
- [ ] [Qual a finalidade do método Length?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-length)
- [ ] [Qual a finalidade do método Remove?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-remove)
- [ ] [Qual a finalidade do método Replace?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-replace)
- [ ] [Qual a finalidade do método Split?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-split)
- [ ] [Qual a finalidade do método Substring?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-substring)
- [ ] [Qual a finalidade do método Trim?](categorias/05_strings_e_manipulacao_de_texto.md#qual-a-finalidade-do-método-trim)
- [ ] [O que é StringBuilder e quando devemos utilizar?](categorias/05_strings_e_manipulacao_de_texto.md#o-que-é-stringbuilder-e-quando-devemos-utilizar)
- [ ] [O que é Regex e quando devemos utilizar?](categorias/05_strings_e_manipulacao_de_texto.md#o-que-é-regex-e-quando-devemos-utilizar)
